...
ALIGNMENT_STATISTICS_DESCRIPTION = (
...
def generate_markdown_report(author, date, alignment_statistics_files, sex_inference_files, coverage_plots, contamination_estimation, contamination_plots, output):
